...
export default function Sidebar11({ ...props }) {
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <MenuItem icon={<Img src="images/img_dashboard.svg" alt="Dashboard" className="h-[30px] w-[22px]" />}>
            Dashboard
          </MenuItem>
          <MenuItem icon={<Img src="images/img_thumbs_up.svg" alt="Thumbsup" className="h-[30px] w-[22px]" />}>
            Employees
          </MenuItem>
