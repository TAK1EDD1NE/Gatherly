...
export default function EventList({
  ...
  eventTitleTwo = "Event two", // Corrected typo here (one -> two)
  eventDescriptionTwo = "partty or conference",
  newText = "new",
  eventTitleThree = "Event three", // Corrected typo here (one -> three)
  eventDescriptionThree = "partty or conference",
  ...props
}) {
  return (
    <div {...props} className={`${props.className} flex justify-center items-center gap-[30px]`}>
      <div className="flex w-[356px] items-center justify-center gap-[22px] rounded-[24px] bg-[#ffffff] p-6 sm:p-5">
      ...
      <div className="relative h-[120px] w-[356px] rounded-[24px] bg-[#ffffff] px-3.5 py-4">
