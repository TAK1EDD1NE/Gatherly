...
export default function Sidebar5({ ...props }) {
  ...
  return (
    <Sidebar
      ...
      className={`${props.className} flex flex-col h-screen pt-[22px] gap-[26px] top-0 sm:pt-5 z-[1] !sticky bg-[#ffffff] overflow-auto`} // Added z-[1]
    >
      ...
      >
        <div>
          ...
          <MenuItem icon={<Img src="images/img_thumbs_up.svg" alt="Thumbsup" className="h-[30px] w-[16px]" />}>
            Salle {/* Corrected Menu Item Text */}
          </MenuItem>
        ...
        <div className="flex flex-col items-start">
          ...
          <MenuItem icon={<Img src="images/img_megaphone.svg" alt="Megaphone" className="h-[30px] w-[22px]" />}>
            Favorites {/* Corrected placement of Favorites */}
          </MenuItem>
          <MenuItem icon={<Img src="images/img_megaphone.svg" alt="Megaphone" className="h-[30px] w-[22px]" />}>
            Contact
          </MenuItem>
